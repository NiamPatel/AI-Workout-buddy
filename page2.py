...
def generate_frames():
    while True:
        ...
        if prediction_label == "Situp Form Good":
            top_text = "Your situps have good form and aren't harming you body."
        elif prediction_label == "Situp Form OK":
            top_text = "You situps could have better form. To get better form try holding you arms striaght against the floor and having something hold you feet down. ."
        else:
            top_text = "Your Situps are damaging to your body watch this video:https://www.youtube.com/watch?v=iL06z9PWYs8&ab_channel=CombatFit"
        ...
        bottom_left_text = """Harder variation: Decline Sit-Ups: Perform sit-ups on a decline bench with your head positioned lower than your feet. This increases the intensity by adding resistance against gravity.

Weighted Sit-Ups: Hold a weight plate, dumbbell, or medicine ball against your chest while performing sit-ups. The added weight increases the difficulty and engages your core muscles further.
"""
        ...
        bottom_right_text = """Easier variation :Crunches: Lie on your back with knees bent and feet flat on the floor. Place hands behind your head or crossed on your chest. Lift your upper body off the floor, engaging your core, and lower back down.

Reverse Crunches: Lie on your back with legs extended and feet together. Place arms by your sides or under your hips for support. Lift your legs off the ground, bend your knees, and bring them towards your chest. Slowly lower your legs back down without touching the floor.
"""
