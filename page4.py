...
def generate_frames():
    while True:
        ...
        if prediction_label == "Planks Form Good":
            top_text = "Your Squats have good form and aren't harming you body."
        elif prediction_label == "Planks Form OK":
            top_text = "You planks could have better form. To get better form try holding your body in a straight line ane make sure your arms are straight."
        else:
            top_text = "Your planks are damaging to your body watch this video:https://www.youtube.com/watch?v=iL06z9PWYs8&ab_channel=CombatFit"
        ...
        bottom_left_text = """Harder variation:Side Plank: Instead of holding a traditional plank position facing down, you'll support your body sideways, balancing on one forearm and the side of your foot. This variation targets your obliques and challenges your stability.

Plank with Leg Lift: Begin in a standard plank position and slowly lift one leg off the ground while maintaining proper form. Alternate legs for an added challenge. This variation engages your glutes and lower back.
"""
        ...
        bottom_right_text = """Easier variation: Knee Plank: Start by performing a plank on your knees instead of your toes. This modification reduces the intensity and puts less stress on your core, making it an easier variation for beginners.

Forearm Plank: Instead of supporting yourself on your hands, lower down onto your forearms. This variation can be less challenging for your wrists and is a good option if you have wrist pain or discomfort.
"""
