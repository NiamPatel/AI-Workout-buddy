...
model = tf.keras.models.load_model('keras_model6.h5')

# Load the label file
with open('labels6.txt', 'r') as f:
...
def generate_frames():
    while True:
        ...
        if prediction_label == "Bicep curl Form Good":
            top_text = "Your lunge have good form and aren't harming you body."
        elif prediction_label == "Bicep curl Form OK":
            top_text = "You Bicep curl could have better form. To get better form try holding you arms striaght against the floor and having something hold you feet down. ."
        else:
            top_text = "Your Bicep curl are damaging to your body watch this video:https://www.youtube.com/watch?v=iL06z9PWYs8&ab_channel=CombatFit"
