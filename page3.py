...
model = tf.keras.models.load_model('keras_model3.h5')
...
def generate_frames():
    while True:
        ...
        if prediction_label == "Squats Form Good":
            top_text = "Your Squats have good form and aren't harming you body."
        elif prediction_label == "Squats Form OK":
            top_text = "You Squats could have better form. To get better form try pushing you but back more as you squat down and sperating your legs more."
        else:
            top_text = "Your Squats are damaging to your body watch this video:https://www.youtube.com/watch?v=iL06z9PWYs8&ab_channel=CombatFit"
        ...
        bottom_left_text = """Harder variation:Decline Sit-ups: Perform sit-ups on a decline bench with your head lower than your feet. This increases the difficulty by placing more emphasis on your abdominal muscles.

Weighted Sit-ups: Hold a weight plate, dumbbell, or medicine ball against your chest while performing sit-ups. The added resistance increases the intensity of the exercise.
"""
        ...
        bottom_right_text = """Crunches: Instead of performing a full sit-up, try doing crunches. Lie on your back with your knees bent and feet flat on the ground. Lift your upper body off the floor, curling your shoulders towards your knees while keeping your lower back on the ground. Lower yourself back down and repeat.
"""
